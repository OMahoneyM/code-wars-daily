...
function presses(str) {
    ...
    for (let char of str) {
        if (charMap['1'].includes(char)) counter++;
        if (charMap['2'].includes(char)) counter += 2;
        if (charMap['3'].includes(char)) counter += 3;
        if (charMap['4'].includes(char)) counter += 4;
        if (charMap['5'].includes(char)) counter += 5;
    }
