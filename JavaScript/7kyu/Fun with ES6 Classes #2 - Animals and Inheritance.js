...
let jaws = new Shark("Jaws", 60, "hungry")

console.log(jaws.name)
console.log(jaws.age)
console.log(jaws.legs)
console.log(jaws.species)
console.log(jaws.status)
console.log(jaws.introduce())
